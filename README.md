...
For more details and guides on how to set up the plugin, please visit the [quickstart page](https://spartacus04.github.io/jext-reborn/documentation/quickstart/).
